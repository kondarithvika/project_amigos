...
# }
def db_config():
   conn=psycopg2.connect("postgresql://rithu:XLwR9lBbDvC7qUUArHTjcg@wide-panda-8901.8nk.gcp-asia-southeast1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full&sslrootcert=root.crt")
   return conn
# def db_config():
